...
if __name__ == '__main__':
    ...
    p = LogisticRegression(n_agent=n_agent, m=m, dim=dim, dataset='a5a', noise_ratio=0.3, graph_type='cycle', kappa=kappa)
    print(p.n_edges)
    ...
    distributed2 = [
        ...
        GT_SAGA(p, n_iters=n_dgd_iters, eta=0.02, x_0=x_0, W=W, n_agent=n_agent, m=m, dim=dim,
                name='GT-SAGA'),
        Q_DSAGA_tracking(p, n_iters=n_dgd_iters, eta=0.02, x_0=x_0, W=W, n_agent=n_agent, m=m, dim=dim, s=1, name=r'Q-SGT,$B_0$=1'),
        Q_DSAGA_tracking(p, n_iters=n_dgd_iters, eta=0.02, x_0=x_0, W=W, n_agent=n_agent, m=m, dim=dim, s=8, name=r'Q-SGT,$B_0$=8'),
        Q_DSAGA_tracking(p, n_iters=n_dgd_iters, eta=0.02, x_0=x_0, W=W, n_agent=n_agent, m=m, dim=dim, s=32, name=r'Q-SGT,$B_0$=32'),
    ]
    ...
    distributed3 = [
        # DGD_tracking(p, n_iters=n_dgd_iters, eta=0.02, x_0=x_0, W=W, dim=dim, name='DGT'),
        QDGT(p, n_iters=n_dgd_iters, eta=0.02, s=8, x_0=x_0, W=W, n_agent=n_agent, dim=dim, name='Q-DGT,\u03B7=0.02'),
        Q_DSAGA_tracking(p, n_iters=n_dgd_iters, eta=0.02, x_0=x_0, W=W, n_agent=n_agent, m=m, dim=dim, s=8,
                         name='Q-SGT,\u03B7=0.02'),
        QDGT(p, n_iters=n_dgd_iters, eta=0.015, s=8, x_0=x_0, W=W, n_agent=n_agent, dim=dim,
             name='Q-DGT,\u03B7=0.015'),
        Q_DSAGA_tracking(p, n_iters=n_dgd_iters, eta=0.015, x_0=x_0, W=W, n_agent=n_agent, m=m, dim=dim, s=8,
                         name='Q-SGT,\u03B7=0.015'),
        QDGT(p, n_iters=n_dgd_iters, eta=0.01, s=8, x_0=x_0, W=W, n_agent=n_agent, dim=dim, name='Q-DGT,\u03B7=0.01'),
        Q_DSAGA_tracking(p, n_iters=n_dgd_iters, eta=0.01, x_0=x_0, W=W, n_agent=n_agent, m=m, dim=dim, s=8,
                         name='Q-SGT,\u03B7=0.01')
    ]
    # 传输比特
    distributed4 = [
        ...
        GT_SAGA(p, n_iters=n_dgd_iters, eta=0.02, x_0=x_0, W=W, n_agent=n_agent, m=m, dim=dim,
                name='GT-SAGA'),
        Q_DSAGA_tracking(p, n_iters=n_dgd_iters, eta=0.02, x_0=x_0, W=W, n_agent=n_agent, m=m, dim=dim, s=1,
                               name='Q-SGT')
    ]

    res = run_exp(distributed4, kappa=kappa, max_iter=n_iters, name='logistic_regression', n_cpu_processes=4, save=True)
